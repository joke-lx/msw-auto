 ...
 */
async function generateSingleMock(endpoint: Endpoint): Promise<MockData> {
 ...
 */
function generateBasedOnPath(endpoint: Endpoint): any {
...
function generateUserMock(path: string, method: string): any {
...
function generateProductMock(path: string, method: string): any {
  if (method === 'post' || path.includes('create')) {
    return {
      success: true,
      product: {
...
function generateOrderMock(path: string, method: string): any {
  if (method === 'post' || path.includes('create')) {
    return {
      success: true,
      order: {
...
function generateListMock(path: string, method: string): any {
